...
const subString = "Uni";
for (let i = 0; i < graduates.length; i++){
  if (graduates[i].university.includes(subString) === true)
...
const lowCaseConvert = zooAnimals.map((animal) => {
...
const sumPop = zooAnimals.reduce((accumulator, animal) => {
  return populationTotal = accumulator + animal.population
}, 0);
